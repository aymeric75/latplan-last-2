...
def main(domainfile, problem_dir, heuristics, cycle, sigma, extension=""):
    ...
    number_of_plans_found=0
    number_of_valid_plans_found=0
    ...
    for root, dirs, files in os.walk(problem_dir):
        ...
        if dirs:
            for d in dirs:
                ...
                try:
                    ...
                    if valid:
                        number_of_valid_plans_found+=1
                        log(f"visually valid plan found")
        ...
        print("number_of_plans_found: {}".format(number_of_plans_found))

        print("number_of_valid_plans_found: {}".format(number_of_valid_plans_found))
