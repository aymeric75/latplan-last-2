...
def main():
    ...
    keys = ['elbo', 'kl_a_z0', 'kl_a_z1', 'kl_z0', 'kl_z0z3', 'kl_z1', 'kl_z1z2', 'loss', 'pdiff_z0z1', 'pdiff_z0z2', 'pdiff_z0z3', 'pdiff_z1z2', 'tau', 'x0y3', 'x1y1', 'x1y2']
    ...
    for cc, (k, v) in enumerate(last_dico.items()):
        ...
        labels = ["Noisy no invs" for i in range(nb_epochs*nb_exps)]
        

        labels = labels + ["Noisy with invs" for i in range(nb_epochs*nb_exps)]
        #labels[-1] = "WITH"
